...
public class PersonServiceImpl implements PersonService {
    ...
    @Override
    public Object getPersonAndRoleById(int id, String outputType) throws EntityNotFoundException {
    ...
    public PersonOutputDto getPersonByUsername(String username) {
        return personRepository.findByUsername(username).orElseThrow().personToPersonOutputDto();
    }
